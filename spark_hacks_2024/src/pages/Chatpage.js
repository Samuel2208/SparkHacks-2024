...
const Chatbot = () => {
  ...
  const handleMessageSubmit = (userMessage) => {
    ...
    if (message) {
      ...
      if (matchedKeyword) {
      ...
      else if (userMessage.toLowerCase().includes('this')) {
        // If the user's message contains a greeting, respond after a delay
        setTimeout(() => {
        ...
        // If the user's message contains a greeting, respond after a delay
        setTimeout(() => {
          const sports = "You can play sports at UIC's Recreation Center on East campus and Sports & Fitness Center on West Campus.";
